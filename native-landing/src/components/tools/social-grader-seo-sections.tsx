...
export function SocialGraderSeoSections() {
  return (
    <div className="mx-auto mt-20 max-w-[760px] space-y-16 border-t border-black/[0.06] pt-16">
      <section>
        <div className={`${FROST_CARD_HERO} space-y-4`}>
          <p className="step-label">Why grade your feed?</p>
          <h2 className="font-playfair text-[clamp(1.75rem,3vw,2.25rem)] italic text-gray-900">
            A quick pulse check before you invest in growth
          </h2>
          <p className="text-[1.05rem] leading-relaxed text-gray-900">
      ...
      <section className="space-y-5">
        <div className={`${FROST_CARD} space-y-4`}>
          <h2 className="font-playfair text-[clamp(1.75rem,3vw,2.25rem)] italic text-gray-900">
