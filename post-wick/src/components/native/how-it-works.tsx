...
const steps = [
  {
    ...
    body: "You add your website. Native does the research on your business, your industry, and your competitors. The rest runs on autopilot.",
    panel: (
  ...
  },
  {
    ...
    body: "While you wait, Native does the research on your business, your industry, and your competitors. We set up a tailored content plan and generate posts for each of your channels.",
    panel: (
  ...
  },
  {
    ...
    body: "Native drafts the posts. You swipe right to approve, left to skip. The rest runs on autopilot.",
    panel: (
  ...
  },
  {
    number: "4",
    label: "Refine",
    title: "Tell Native what to change. It does it.",
    body: "Almost love the post, but not quite? Describe it in plain words. Native rewrites the caption, generates new image variations, and lets you pick your favorite.",
    panel: (
...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="bg-cream px-10 py-24">
      <div className="mx-auto max-w-[1200px]">
        <div className="text-center">
          <p className="step-label">How it works</p>
          <h2 className="mx-auto mt-3 max-w-[720px] font-playfair text-[clamp(2rem,4vw,3rem)] italic text-near-black">
            See how Post-Wick works in four steps.
          </h2>
        </div>
            ...
            >
              <div className={step.number === "2" || step.number === "4" ? "lg:order-2" : ""}>
                ...
                <div className="mt-6 flex gap-3">
                  <Link
                    href="/sign-in"
                    className="rounded-full border border-near-black px-5 py-2 text-sm font-medium"
                  >
                    Log in
                  </Link>
                  <Link
                    href="/sign-up"
                    className="rounded-full bg-native-black px-5 py-2 text-sm font-medium text-white"
                  >
                    Get started
                  </Link>
                </div>
